...
def main():
	...
	EBkeys = list(EB.keys())
	EBlst = [EB[EBkeys[ix]] for ix in random.choice(len(EBkeys), size=nv_samps, replace=False, p=None)]
	...
	FODFTensor = odf_sh_to_sharp(ODFTensor, 
								sphere, 
								basis="descoteaux07", 
								ratio=3/15., sh_order=sh_order,
								lambda_=1., tau=0.5, r2_term=False) 
